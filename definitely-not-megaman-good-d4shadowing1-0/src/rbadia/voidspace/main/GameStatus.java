...
public class GameStatus {
	...
	private List<Boolean> newAsteroid;
	...
	public synchronized boolean isNewAsteroid(int i) {
		return newAsteroid.get(i);
	}

	public synchronized List<Boolean> getNewAsteroid() {
		return newAsteroid;
	}
	
	public synchronized void setIsNewAsteroids() {
		this.newAsteroid = new ArrayList<>(4);
		for(int i = 0; i < 4; i++) {
			this.newAsteroid.add(false);
		}
	}
	
	public synchronized void setNewAsteroidBool(boolean isNew, int i) {
		this.newAsteroid.set(i, isNew);
	}
